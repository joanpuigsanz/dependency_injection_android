...
public class MachineModule {
	...
	@Provides @Singleton public Heater provideHeatere() {
		return new ElectricHeater();
	}
	
	@Provides @Singleton public Mold providesMold(){
		return new KitKatRobotMold();
	}
	
	@Provides @Singleton public Machine providesMachine(KitKatMachine machine){
		return machine;
	}
