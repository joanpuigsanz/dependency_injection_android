...
import com.kitkatmachine.module.ActivityModule;
...
public class BaseFragmentActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// application graph.
		KitKatMachineApplication application = (KitKatMachineApplication) getApplication();
	...
	protected List<Object> getModules() {
		ArrayList<Object> newModules = new ArrayList<Object>();
		newModules.add(new ActivityModule(this));
		return newModules;
	}
